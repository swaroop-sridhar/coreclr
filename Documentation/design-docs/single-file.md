...
* Is widely compatible: Apps that contain pure MSIL, ready-to-run assemblies, native binaries, configuration files, etc. can be packaged into one executable.
...
* Has no degradation in tooling experience: interaction with like debuggers, profilers etc. should remain unaffected.
