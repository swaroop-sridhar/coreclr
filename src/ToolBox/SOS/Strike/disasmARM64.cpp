...
///
void ARM64Machine::DumpGCInfo(GCTable gcTable, unsigned methodSize, printfFtn gcPrintf, bool encBytes, bool bPrintHeader) const
{
    if (bPrintHeader)
    {
    ...
    ARM64GCDump::GCDump gcDump(gcTable.Version, encBytes, 5, true);
