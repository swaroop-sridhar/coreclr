...
DECLARE_API(GCInfo)
{
    ...
    GCTable gcTable = { table, GCINFO_VERSION };
    unsigned int methodSize = (unsigned int)codeHeaderData.MethodSize;

    g_targetMachine->DumpGCInfo(gcTable, methodSize, ExtOut, true /*encBytes*/, true /*bPrintHeader*/);
...
VOID CALLBACK DumpGCTableFiberEntry (LPVOID pvGCEncodingInfo)
{
    ...
    GCTable gcTable = { pInfo, GCINFO_VERSION };
    g_targetMachine->DumpGCInfo(gcTable, pInfo->methodSize, DecodeGCTableEntry, false /*encBytes*/, false /*bPrintHeader*/);
