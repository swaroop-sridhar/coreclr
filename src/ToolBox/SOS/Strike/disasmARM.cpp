...
///
void ARMMachine::DumpGCInfo(GCTable gcTable, unsigned methodSize, printfFtn gcPrintf, bool encBytes, bool bPrintHeader) const
{
#ifndef FEATURE_PAL
    if (bPrintHeader)
    {
    ...
    ARMGCDump::GCDump gcDump(gcTable.Version, encBytes, 5, true);
