...
#else
    std::list<MemoryBlockDesc*> m_MemoryBlocks;
#endif
...
#else
        m_MemoryBlocks.push_back(pMemBlockDesc);
#endif
...
#else
    std::vector<InterruptibleRange> m_InterruptibleRanges;
    std::vector<LifetimeTransition> m_LifetimeTransitions;
#endif
