...
namespace System.Runtime.InteropServices
{
    ...
    public static partial class Marshal
    {
        ...
        {
            return LoadLibraryFromPath(libraryPath, true);
        }
        ...
        /// </summary>
        /// <param name="libraryName">The name of the native library to be loaded</param>
        /// <param name="handle">The out-parameter for the loaded NativeLibrary object</param>
        ...
        {
            handle = LoadLibraryFromPath(libraryPath, false);
        ...
        /// <exception cref="System.InvalidOperationException">If the handle is invalid</exception>
        ...
        /// Helper functions to implement the NativeLibrary API

        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        internal static extern IntPtr LoadLibraryFromPath(string libraryName, bool shouldThrow);
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        internal static extern IntPtr LoadLibraryByName(string libraryName, RuntimeAssembly callingAssembly, uint dllImportSearchPathFlag, bool shouldThrow);
    }
}