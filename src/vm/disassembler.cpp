...
InitDisasm_Sig *Disassembler::External_InitDisasm = nullptr;;
FinishDisasm_Sig *Disassembler::External_FinishDisasm = nullptr;;
DisasmInstruction_Sig *Disassembler::External_DisasmInstruction = nullptr;;
