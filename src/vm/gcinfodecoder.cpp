...
GcInfoDecoder::GcInfoDecoder(
            ...
            : m_Reader(dac_cast<PTR_CBYTE>(gcTable.Info)
#ifdef VERIFY_GCINFO
                + sizeof(size_t)
#endif            
              )
...
#ifdef _DEBUG
            , m_Flags( flags )
            , m_GcInfoAddress(dac_cast<PTR_CBYTE>(gcTable.Info))
            , m_Version(gcTable.Version)
#endif
#ifdef VERIFY_GCINFO
            , m_DbgDecoder(dac_cast<PTR_CBYTE>(gcTable.Info) +
                                (((UINT32)((PTR_BYTE)(TADDR)gcTable.Info)[3])<<24)+
                                (((UINT32)((PTR_BYTE)(TADDR)gcTable.Info)[2])<<16)+
                                (((UINT32)((PTR_BYTE)(TADDR)gcTable.Info)[1])<<8)+
