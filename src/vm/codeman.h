...
public:
    ...
    virtual GCTable GetGCTable(const METHODTOKEN& MethodToken)=0;
    PTR_VOID GetGCInfo(const METHODTOKEN& MethodToken)
    {
        return GetGCTable(MethodToken).Info;
    }
...
public:
    ...
    virtual TypeHandle  ResolveEHClause(EE_ILEXCEPTION_CLAUSE* pEHClause,
                                        CrawlFrame *pCf);
#endif // !DACCESS_COMPILE
    GCTable         GetGCTable(const METHODTOKEN& MethodToken);
#endif // !CROSSGEN_COMPILE
...
public:
    ...
    virtual GCTable  GetGCTable(const METHODTOKEN& MethodToken);
...
public:
    ...
    {
        WRAPPER_NO_CONTRACT; 
        return GetJitManager()->GetGCTable(GetMethodToken());
    }

    PTR_VOID GetGCInfo()
    {
        return GetGCTable().Info;
    }
