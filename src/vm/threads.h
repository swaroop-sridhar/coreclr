...
#ifdef FEATURE_UNIX_AMD64_STRUCT_PASSING
EXTERN_C void STDCALL OnHijackStructInRegsRetClassWorker(HijackArgs * pArgs); // Struct returned in two registers
#endif // FEATURE_UNIX_AMD64_STRUCT_PASSING
#ifdef FEATURE_MULTIREG_RETURN
...
#ifdef FEATURE_UNIX_AMD64_STRUCT_PASSING
    friend void STDCALL OnHijackStructInRegsRetClassWorker(HijackArgs *pArgs);
#endif // FEATURE_UNIX_AMD64_STRUCT_PASSING
#ifdef FEATURE_MULTIREG_RETURN
...
private:
    ...
    // m_pHijackReturnTypeClass for GcInfo ver 1 (See OnHijackStructInRegsRetClassWorker)
