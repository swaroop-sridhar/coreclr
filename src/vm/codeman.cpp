...
GCTable EEJitManager::GetGCTable(const METHODTOKEN& MethodToken)
{
    CONTRACTL {
        NOTHROW;
        GC_NOTRIGGER;
...
GCTable NativeImageJitManager::GetGCTable(const METHODTOKEN& MethodToken)
{
    CONTRACTL {
        NOTHROW;
        GC_NOTRIGGER;
                                                   ...
                                                   MethodRegionInfo * methodRegionInfo)
{
    ...
    methodRegionInfo->hotSize          = GetCodeManager()->GetFunctionSize(GetGCTable(MethodToken));
...
GCTable MethodIterator::GetGCTable()
{
    LIMITED_METHOD_CONTRACT;
...
void MethodIterator::GetMethodRegionInfo(IJitManager::MethodRegionInfo *methodRegionInfo)
{
    ...
    GCTable gcTable = GetGCTable();
    methodRegionInfo->hotSize          = ExecutionManager::GetNativeImageJitManager()->GetCodeManager()->GetFunctionSize(gcTable);
    methodRegionInfo->coldSize         = 0;
...
GCTable ReadyToRunJitManager::GetGCTable(const METHODTOKEN& MethodToken)
{
    CONTRACTL {
        NOTHROW;
        GC_NOTRIGGER;
